...
// pass can report itself ready and still submit nothing when every visible
// cluster is near/mixed-risk or the direct path rejects the pass. Guard-safe
// and side-only clusters qualify without enabling full near-plane clipping.
