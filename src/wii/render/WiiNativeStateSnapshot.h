 ...
 * existing OptiCraft render semantics while bypassing the public OpenGL-compatible
...
void wii_gx_native_forget_texture_id(int texture);
void wii_gx_native_clear_bound_texture_ids(void);
