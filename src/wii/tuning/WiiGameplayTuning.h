...
// Wii keeps the Legacy UI on the native 2x GUI scale. Individual Legacy
// screens that need a narrower console layout expose their own width policy.
#define WII_LEGACY_GUI_SCALE 2.0
#define WII_LEGACY_CREATE_WORLD_PANEL_WIDTH 208
...
// path without opting Wii into the rest of PLATFORM_CONSOLE_LOW. It replaces
...
#define WII_USE_HEIGHTMAP_TERRAIN                 1
#endif
