...
public:
    ...
    bool canRenderStaticPart(TileEntity *tileentity);
    bool renderStaticPart(TileEntity *tileentity, double d, double d1, double d2);
    bool prepareStaticPart(TileEntity *tileentity);
    ...
    // Uncached lookup behind getSpecialRendererForEntity().
    TileEntitySpecialRenderer *resolveSpecialRendererForEntity(TileEntity *tileentity);
