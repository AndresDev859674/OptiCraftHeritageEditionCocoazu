...
public:
	...
	// Bounded-world streaming: chunks with |x| and |z| within this radius of
	// the origin are preloaded on the loading screen and never unloaded while
	// this dimension is open. -1 means the dimension streams normally.
	virtual int_t getResidentChunkRadius() const { return -1; }
