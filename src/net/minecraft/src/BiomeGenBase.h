...
public:
    ...
    virtual bool advanceDecorationExtra(World *world, Random &random, int_t chunkX, int_t chunkZ, int_t &index);
...
protected:
    ...
    virtual bool isReusableWorldGenForTrees(const WorldGenerator *generator) const;
