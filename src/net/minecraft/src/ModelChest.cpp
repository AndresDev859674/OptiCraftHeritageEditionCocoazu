...
void ModelChest::renderStaticPart()
{
    chestBelow->render(1.0f / 16.0f);
}

void ModelChest::renderDynamicPart()
{
...
void ModelChest::prepareStaticPart()
{
    if (chestBelow != nullptr)
        chestBelow->ensureCompiled(1.0f / 16.0f);
}
