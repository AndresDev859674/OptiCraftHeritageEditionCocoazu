...
public:
	...
	// Same lookup with a caller-supplied factory for MapDataBase types other
	// than MapData. A null factory only returns already-loaded data.
	MapDataBase* loadData(const std::string &s, MapDataFactory factory);
